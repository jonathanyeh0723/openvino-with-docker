...
def draw_detections(frame, detections, palette, labels, output_transform):
    ...
    for detection in detections:
        ...
        text = '{} {:.1%}'.format(det_label, detection.score)
        ...
        cv2.rectangle(frame, (xmin, ymin), (xmin + rect_width, ymin - rect_height), color, cv2.FILLED)
        cv2.putText(frame, text, (xmin + padding, ymin - text_height + padding), cv2.FONT_HERSHEY_PLAIN, 1., (255, 255, 255), lineType=cv2.LINE_AA)
